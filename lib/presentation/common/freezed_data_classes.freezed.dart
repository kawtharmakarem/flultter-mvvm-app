...
class _$RegisterObjectImpl implements _RegisterObject {
  _$RegisterObjectImpl(this.userName, this.mobileCountryCode, this.mobileNumber,
  ...
  @override
  String toString() {
    return 'RegisterObject(userName: $userName, mobileCountryCode: $mobileCountryCode, mobileNumber: $mobileNumber, email: $email, password: $password, profilePicture: $profilePicture)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, userName, mobileCountryCode,
